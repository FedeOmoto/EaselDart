...
class MouseEvent extends create_dart.Event {
   ...
   */
  double get localX {
    return (currentTarget as DisplayObject).globalToLocal(rawX, rawY).x;
  }
   ...
   */
  double get localY {
    return (currentTarget as DisplayObject).globalToLocal(rawX, rawY).y;
  }

  MouseEvent(String type, bool bubbles, bool
      cancelable, this.stageX, this.stageY, this.nativeEvent, this.pointerID, this.primary, double
      rawX, double rawY) : super(type, bubbles, cancelable) {
